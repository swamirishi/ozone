 ...
 */
public class TestSplitTableIterOperator {

  private static ThrottledThreadpoolExecutor executor;
  private static final Logger LOG = LoggerFactory.getLogger(TestSplitTableIterOperator.class);
  ...
  private void testParallelTableOperator(Table<Integer, Integer> intTable,
      SplitTableIterOperator<Table<Integer, Integer>, Integer, Integer> parallelTableOperator,
  ...
  public void testParallelTableOperator(int keyJumps, Integer start, Integer end, int boundJumps)
    ...
    SplitTableIterOperator<Table<Integer, Integer>, Integer, Integer> splitTableIterOperator =
        new SplitTableIterOperator<Table<Integer, Integer>, Integer, Integer>(executor, intTable, IntegerCodec.get()) {
          @Override
          protected List<Integer> getBounds(Integer startKey, Integer endKey) {
            return bounds;
          }
        };
    testParallelTableOperator(intTable, splitTableIterOperator, maxKeyIdx, keyJumps, start, end, bounds, opr, null);
  }
  ...
  public void testParallelTableOperatorWithException(int keyJumps, Integer start, Integer end, int boundJumps)
    ...
    testParallelTableOperator(intTable, splitTableIterOperator, maxKeyIdx, keyJumps, start, end, bounds, opr,
