 ...
 */
public abstract class SplitTableIterOperator<TABLE extends Table<K, V>, K, V> {
  private final TABLE table;
  private final Codec<K> keyCodec;
  private final Comparator<K> comparator;
  private final ThrottledThreadpoolExecutor executor;

  public SplitTableIterOperator(ThrottledThreadpoolExecutor throttledThreadpoolExecutor,
