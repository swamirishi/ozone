...
public class TestEndPoint {
  ...
  public static void setUp() throws Exception {
    ...
    volumeChoosingPolicy = VolumeChoosingPolicyFactory.getPolicy(SCMTestUtils.getConf());
  ...
  public void testGetVersionTask() throws Exception {
    ...
    try (EndpointStateMachine rpcEndPoint = createEndpoint(conf,
      ...
      OzoneContainer ozoneContainer = new OzoneContainer(
          datanodeDetails, conf, getContext(datanodeDetails), volumeChoosingPolicy);
  ...
  private StateContext getContext(DatanodeDetails datanodeDetails) {
    ...
    Mockito.when(stateMachine.getReconfigurationHandler())
        .thenReturn(new ReconfigurationHandler("DN", new OzoneConfiguration(), op -> { }));
